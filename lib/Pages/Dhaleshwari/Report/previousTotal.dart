...
class PreviousTotalReportDhaleshwari extends StatefulWidget {
  @override
  _PreviousTotalReportDhaleshwariState createState() => _PreviousTotalReportDhaleshwariState();
}

class _PreviousTotalReportDhaleshwariState extends State<PreviousTotalReportDhaleshwari> {
  final GlobalKey<AnimatedListState> _listKey = GlobalKey<AnimatedListState>();

  @override
  void initState() {
    var fetchData = Provider.of<GetDhaleshwariData>(context, listen: false);
    fetchData.get_previosreportDhaleshwari();
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<GetDhaleshwariData>(builder: (content, data, child) {
