...
class DhaleshwariReportSearch extends StatefulWidget {
  @override
  _DhaleshwariReportSearchState createState() =>
      _DhaleshwariReportSearchState();
}

class _DhaleshwariReportSearchState extends State<DhaleshwariReportSearch> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
                    ...
                    child: DropdownButton(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          select = newValue;
                          rateCalculation();
                          var fetchData = Provider.of<GetDhaleshwariData>(
                              context,
                              listen: false);
            ...
            Container(
              child: Consumer<GetDhaleshwariData>(
            ...
            Expanded(child: Consumer<GetDhaleshwariData>(
              builder: (content, data, child) {
                return data.searchModel != null
                    ? Container(
                        width: _width,
                            ...
                            itemBuilder: (context, index) {
                              return SearchReportView(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Image(
                                      image: NetworkImage(
                                        "http://103.218.24.35/image/${data.searchModel.data[index].imagase}",
                                      ),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
