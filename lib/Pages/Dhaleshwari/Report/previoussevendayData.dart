...
class sevenDaysDataDhaleshwari extends StatefulWidget {
  @override
  _sevenDaysDataDhaleshwariState createState() => _sevenDaysDataDhaleshwariState();
}

class _sevenDaysDataDhaleshwariState extends State<sevenDaysDataDhaleshwari> {
  ...
  void initState() {
    ...
    fetchData.get_sevenDaysDataDhaleshwari().then((value) {
      setState(() {
        isLoading = false;
      });
    });
