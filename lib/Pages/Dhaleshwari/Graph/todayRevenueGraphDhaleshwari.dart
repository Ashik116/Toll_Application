...
class TodayRevenueGraphDhaleshwari extends StatefulWidget {
  @override
  _TodayRevenueGraphDhaleshwariState createState() =>
      _TodayRevenueGraphDhaleshwariState();
}

class _TodayRevenueGraphDhaleshwariState
    extends State<TodayRevenueGraphDhaleshwari> {
  int touchedIndex;
  var colorList = [
    Color(0xFF072DE5),
    Color(0xffBC243C),
