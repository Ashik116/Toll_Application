...
class PreviousVehicleGraphDhaleshwari extends StatefulWidget {
  @override
  _PreviousVehicleGraphDhaleshwariState createState() => _PreviousVehicleGraphDhaleshwariState();
}

class _PreviousVehicleGraphDhaleshwariState
    extends State<PreviousVehicleGraphDhaleshwari> {
  ...
  _createSampleData() {
    ...
    var d = context.read<GetDhaleshwariData>().previousDayModel.data;

    for (var v in context.read<GetDhaleshwariData>().previousDayModel.data) {
  ...
  void initState() {
    ...
    fetchData.get_previosreportDhaleshwari().then((value) {
      setState(() {
