...
class PreviousVipPassDhaleshwari extends StatefulWidget {
  @override
  _PreviousVipPassDhaleshwariState createState() => _PreviousVipPassDhaleshwariState();
}

class _PreviousVipPassDhaleshwariState extends State<PreviousVipPassDhaleshwari> {
  ...
  void initState() {
    ...
    fetchData.get_vippreviosreportDhaleshwari().then((value) {
      setState(() {
        isLoading = false;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return isLoading ? loadingAnimation() : Consumer<GetDhaleshwariData>(builder: (content, data, child) {
