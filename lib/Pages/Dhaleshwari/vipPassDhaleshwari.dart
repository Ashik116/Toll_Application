...
class VipPassDhaleshwari extends StatefulWidget {
  @override
  _VipPassDhaleshwariState createState() => _VipPassDhaleshwariState();
}

class _VipPassDhaleshwariState extends State<VipPassDhaleshwari> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 5,),
        Expanded(
          child: _todayButtonSelected ? TodayVipPassDhaleshwari() : _previousVIPSelected
              ? PreviousVipClassDhaleshwari()
              :PreviousVipPassDhaleshwari(),
        )
      ],
    );
  }
