...
class TodayVipPassDhaleshwari extends StatefulWidget {
  @override
  _TodayVipPassDhaleshwariState createState() => _TodayVipPassDhaleshwariState();
}

class _TodayVipPassDhaleshwariState extends State<TodayVipPassDhaleshwari> {
  @override
  Widget build(BuildContext context) {
    final providerThemeAndColor = Provider.of<ThemeAndColorProvider>(context);
    final vehicleDataList = Provider.of<TodayVipPassReportDhaleshwariDataModule>(context);
