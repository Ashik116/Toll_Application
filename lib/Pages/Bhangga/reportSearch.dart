...
class BhangaReportSearch extends StatefulWidget {
  @override
  _BhangaReportSearchState createState() => _BhangaReportSearchState();
}

class _BhangaReportSearchState extends State<BhangaReportSearch> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
                    ...
                    child: DropdownButton(
                      ...
                      onChanged: (newValue) {
                        setState(() {
                          select = newValue;
                          rateCalculation();
                          var fetchData = Provider.of<GetBhangaData>(context,
                              listen: false);
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: () {
                              var fetchData = Provider.of<GetBhangaData>(
                                  context,
                                  listen: false);
                              fetchData.search_report(
                                  DateFormat('yyyy-MM-dd')
            ...
            Expanded(child: Consumer<GetBhangaData>(
              builder: (content, data, child) {
                return data.searchModel != null
                    ? Container(
                        width: _width,
                            ...
                            itemBuilder: (context, index) {
                              return SearchReportView(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Image(
                                      image: NetworkImage(
                                        "http://103.239.254.102/image/${data.searchModel.data[index].imagase}",
                                      ),
                                      fit: BoxFit.cover,
                                    ),
                                  ),
