...
import 'package:toll_plaza/Pages/Bhangga/Bhanga%20Repot/bhangaRepotPage.dart';
...
class BhangaHomePage extends StatefulWidget {
  @override
  _BhangaHomePageState createState() => _BhangaHomePageState();
}

class _BhangaHomePageState extends State<BhangaHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    try{
      isBhanga =sharedPreferences.getBool('isBhanga');
    }catch(e){}
