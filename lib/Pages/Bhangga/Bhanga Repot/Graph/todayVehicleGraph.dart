...
class TodayVehicleGraphBhanga extends StatefulWidget {
  @override
  _TodayVehicleGraphBhangaState createState() => _TodayVehicleGraphBhangaState();
}

class _TodayVehicleGraphBhangaState
    extends State<TodayVehicleGraphBhanga> {
  int touchedIndex;
  var colorList = [
    Color(0xff063be8),
    Color(0xff498f03),
  ...
  Widget build(BuildContext context) {
    ...
    var dataVip = Provider.of<TodayVipPassReportBhangaDataModule>(context);
    return Card(
