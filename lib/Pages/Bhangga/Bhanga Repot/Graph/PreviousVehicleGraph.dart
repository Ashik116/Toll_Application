...
class PreviousVehicleGraphBhanga extends StatefulWidget {
  @override
  _PreviousVehicleGraphBhangaState createState() => _PreviousVehicleGraphBhangaState();
}

class _PreviousVehicleGraphBhangaState
    extends State<PreviousVehicleGraphBhanga> {
  ...
  _createSampleData() {
    ...
    var d = context.read<GetBhangaData>().previousDayModel.data;
