...
class PreviousVipClassBhanga extends StatefulWidget {
  @override
  _PreviousVipClassBhangaState createState() => _PreviousVipClassBhangaState();
}

class _PreviousVipClassBhangaState extends State<PreviousVipClassBhanga> {
