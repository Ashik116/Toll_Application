...
class TodayReportBhanga extends StatefulWidget {
  @override
  _TodayReportBhangaState createState() => _TodayReportBhangaState();
}

class _TodayReportBhangaState extends State<TodayReportBhanga> {
  Timer timer;
  @override
  void initState() {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<TodayReportBhangaDataModule>(context);
    return Scaffold(
