...
class sevenDaysVehicleDataRegnumCharsindur extends StatefulWidget {
  @override
  _sevenDaysVehicleDataRegnumCharsindurState createState() =>
      _sevenDaysVehicleDataRegnumCharsindurState();
}

class _sevenDaysVehicleDataRegnumCharsindurState extends State<sevenDaysVehicleDataRegnumCharsindur> {
  final GlobalKey<AnimatedListState> _listKey = GlobalKey<AnimatedListState>();
  bool isLoading = true;

  @override
  void initState() {
    var fetch_data = Provider.of<GetDataRegnumCharsindur>(context, listen: false);
  ...
  Widget build(BuildContext context) {
    ...
    return isLoading
        ? loadingAnimation()
        : Consumer<GetDataRegnumCharsindur>(builder: (content, data, child) {
        ...
        itemBuilder: (BuildContext context, int index,
          ...
          return index == -1
            ...
            child: SevenDaysRowDesign(
              date: data.sevenDaysData.data[index].date
                  .toString(),
              totalAmount: data
              ...
              rickshawVan: data
                  ...
                  .toString(),
              motorcycle: data
                  .sevenDaysData.data[index].motorcycle
                  .toString(),
              threeFourWheeler: data
                  .sevenDaysData.data[index].threefourwheeler
                  .toString(),
              sedanCar: data
                  .sevenDaysData.data[index].sedancar
                  .toString(),
              fourWheeler: data
                  .sevenDaysData.data[index].four_wheeler
                  .toString(),
              microBus: data
                  .sevenDaysData.data[index].microbus
                  .toString(),
              minibus: data.sevenDaysData.data[index].minibus
                  .toString(),
              agrouse: data.sevenDaysData.data[index].agrouse
                  .toString(),
              miniTruck: data
                  .sevenDaysData.data[index].minitruck
                  .toString(),
              bigBus: data.sevenDaysData.data[index].bigbus
                  .toString(),
              mediumTruck: data
