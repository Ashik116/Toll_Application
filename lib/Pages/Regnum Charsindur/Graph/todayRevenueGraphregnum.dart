...
class TodayRevenueGraphRegnumCharsindur extends StatefulWidget {
  @override
  _TodayRevenueGraphRegnumCharsindurState createState() =>
      _TodayRevenueGraphRegnumCharsindurState();
}

class _TodayRevenueGraphRegnumCharsindurState
    extends State<TodayRevenueGraphRegnumCharsindur> {
  int touchedIndex;
  var colorList = [
    Color(0xFFC3447A),
    Color(0xffBC243C),
