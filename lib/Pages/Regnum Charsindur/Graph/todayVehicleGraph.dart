...
class TodayVehicleGraphRegnumCharsindur extends StatefulWidget {
  @override
  _TodayVehicleGraphRegnumCharsindurState createState() =>
      _TodayVehicleGraphRegnumCharsindurState();
}

class _TodayVehicleGraphRegnumCharsindurState
    extends State<TodayVehicleGraphRegnumCharsindur> {
  int touchedIndex;
  var colorList = [
    Color(0xFFC3447A),
    Color(0xffBC243C),
  ...
  Widget build(BuildContext context) {
    var data = Provider.of<TodayReportRegnumCharsindurDataModule1>(context);
    var dataVip = Provider.of<TodayVipPassRegnumCharsindurReportDataModule>(context);
    return Card(
