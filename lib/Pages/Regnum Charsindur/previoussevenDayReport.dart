...
class PreviousReportRegnumCharsindurUpdate extends StatefulWidget {
  @override
  _PreviousReportRegnumCharsindurUpdateState createState() =>
      _PreviousReportRegnumCharsindurUpdateState();
}

class _PreviousReportRegnumCharsindurUpdateState
    extends State<PreviousReportRegnumCharsindurUpdate> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<GetDataRegnumCharsindur>(builder: (content, data, child) {
