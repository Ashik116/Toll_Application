...
class TodayReportRegnumCharsindurUpdate extends StatefulWidget {
  @override
  _TodayReportRegnumCharsindurUpdateState createState() =>
      _TodayReportRegnumCharsindurUpdateState();
}

class _TodayReportRegnumCharsindurUpdateState
    extends State<TodayReportRegnumCharsindurUpdate> {
  ...
  Widget build(BuildContext context) {
    ...
    Provider.of<TodayReportRegnumCharsindurDataModule1>(context);
    return Scaffold(
