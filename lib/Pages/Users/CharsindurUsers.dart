...
class CharsindurUsers extends StatefulWidget {
  // const ({Key? key}) : super(key: key);
  @override
  _State createState() => _State();
}

class _State extends State<CharsindurUsers> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: isLoading ? loadingAnimation() : RefreshIndicator(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Center(
                child: Text("Charsindur Users List",
                  style: TextStyle(
