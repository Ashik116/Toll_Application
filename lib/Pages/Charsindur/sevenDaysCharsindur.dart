...
class sevenDaysDataCharsindur extends StatefulWidget {
  @override
  _sevenDaysDataCharsindurState createState() =>
      _sevenDaysDataCharsindurState();
}

class _sevenDaysDataCharsindurState extends State<sevenDaysDataCharsindur> {
  final GlobalKey<AnimatedListState> _listKey = GlobalKey<AnimatedListState>();
  bool isLoading = true;

  @override
  void initState() {
    var fetch_data = Provider.of<GetDataCharsindur>(context, listen: false);
