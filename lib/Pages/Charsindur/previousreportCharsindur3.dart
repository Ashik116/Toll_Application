...
class PreviousReportCharsindurUpdate extends StatefulWidget {
  @override
  _PreviousReportCharsindurUpdateState createState() =>
      _PreviousReportCharsindurUpdateState();
}

class _PreviousReportCharsindurUpdateState
    extends State<PreviousReportCharsindurUpdate> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<GetDataCharsindur>(builder: (content, data, child) {
