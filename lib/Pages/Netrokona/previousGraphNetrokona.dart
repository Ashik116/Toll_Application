...
class PreviousGraphNetrokona extends StatefulWidget {

  @override
  _PreviousGraphNetrokonaState createState() => _PreviousGraphNetrokonaState();
}

class _PreviousGraphNetrokonaState extends State<PreviousGraphNetrokona> {
  ...
  _createSampleData() {
    ...
    for(var v in context.read<PreviousReportNetrokonaDatabase>().previousDataListNetrokona){
