...
import 'package:toll_plaza/Pages/Netrokona/graphNetrokona.dart';
...
class NetrokonaReportPage extends StatefulWidget {
  const NetrokonaReportPage({Key key}) : super(key: key);

  @override
  _NetrokonaReportPageState createState() => _NetrokonaReportPageState();
}

class _NetrokonaReportPageState extends State<NetrokonaReportPage> {
  bool isLoading = true;
  ...
  Widget build(BuildContext context) {
    ...
    DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: <Widget>[
            TodayReportNetrokona(),
            PreviousReportNetrokona(),
            GraphNetrokona(),
          ],
        ),
      ),
