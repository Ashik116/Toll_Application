...
class SevenDaysRowDesignBhanga extends StatefulWidget {
  String date;
  String totalAmount;
  ...
  @override
  _SevenDaysRowDesignBhangaState createState() => _SevenDaysRowDesignBhangaState();
}

class _SevenDaysRowDesignBhangaState extends State<SevenDaysRowDesignBhanga> {
  String date;
  String totalAmount;
