...
class TodayReportNetrokonaDatabase with ChangeNotifier {
  var axel2;
  var axel3;
  var axel4;
  var axel5;
  ...
  List<TodayReportNetrokonaDatabase> dataList = [];
  List<WinVehicleReportModule> vehicleDataList = [];

  TodayReportNetrokonaDatabase({
    this.axel2,
    this.axel3,
    this.axel4,
    this.axel5,
  ...
  void getShortReport() {
    try{
      ...
      reference.child("netrokona").child(today).onValue.listen((event) async {
  ...
  void getReport() {
    try{
      ...
      reference.child("netrokona").child(today).onValue.listen((event) async {
        ...
        if (data != null) {
          dataList.clear();
          dataList.add(TodayReportNetrokonaDatabase(
              axel2: 0,
              axel3: 0,
              axel4: 0,
              axel5: 0,
          ...
          var vehicleData = TodayReportNetrokonaDatabase.fromJson(data["RegularReport"]);
  ...
  TodayReportNetrokonaDatabase.fromJson(Map<dynamic, dynamic> json) {
    axel2 = json['axel2'];
    axel3 = json['axel3'];
    axel4 = json['axel4'];
    axel5 = json['axel5'];
